            ...
            <div class="twelve wide column">
                ...
                <?php
                    ...
                    if(isset($_POST['submit_child'])) {
                        ...
                        $child_interests = $_POST['child_interests'];

                        $sql = "INSERT INTO children (cname, cdob, cyoe, cclass, interests, cstory, cimage) VALUES ('$child_name', '$child_dob', '$child_yoe', '$child_class', '$child_interests', '$child_story_behind', '$child_pic')";
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    ...
                    <div class="field">
                        ...
                        <textarea name="child_interests" rows="2" required></textarea>
                    </div>
                    <div class="field">
