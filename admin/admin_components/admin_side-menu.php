<div class="four wide column" id="example1">
    <div class="ui secondary vertical pointing menu">
        ...
        <!-- New Calendar Menu Items -->
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/calendar/calendar.php" ? "active" : "");?>" href="../calendar/calendar.php">Calendar</a>
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/calendar/add_event.php" ? "active" : "");?>" href="../calendar/add_event.php">Add Event</a>
    </div>
</div>