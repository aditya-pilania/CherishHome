            ...
            <div class="twelve wide column">
                ...
                <form action="<?php $_PHP_SELF ?>" method="post" class="ui form">
                    ...
                    <?php
                        ...
                        $sql = "SELECT cid, cname, cdob, cyoe, cclass, cimage FROM children WHERE cid='$cid'";
                    ...
                    <span>
                        <div class="description">
                            ...
                            <?php
                            $childImg = !empty($row['cimage']) ? $row['cimage'] : 'defaultimg.png';
                            ?>
                            <img class="ui small top aligned circular image" img src="img/<?php echo $childImg; ?>" style="width: 120px;"> 
